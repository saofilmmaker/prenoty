          ...
          <div className="space-y-8 pb-8">
            ...
            <div className="pb-2">
              ...
              <div className="flex justify-center" style={{ marginTop: salone.copertina ? -32 : 0, marginBottom: 12, position: "relative", zIndex: 1 }}>
                {salone.logo ? (
                  <img src={salone.logo} alt={salone.nome} className="w-16 h-16 rounded-2xl object-cover" style={{ border: `4px solid ${T.bg}`, boxShadow: "0 2px 12px rgba(0,0,0,0.12)" }} />
                ) : (
                  <div className="w-16 h-16 rounded-2xl flex items-center justify-center text-xl font-semibold" style={{ backgroundColor: T.accentSoft, color: T.accent, border: `4px solid ${T.bg}`, boxShadow: "0 2px 12px rgba(0,0,0,0.12)" }}>
